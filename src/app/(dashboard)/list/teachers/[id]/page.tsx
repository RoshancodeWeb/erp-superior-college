          ...
          <div className="w-full flex bg-roshanSky rounded-md gap-2 py-2 px-1 md:py-4 md:px-2 xl:w-2/3 xl:h-fit">
            ...
            <div className="w-[55%] flex-1 bbmd:w-full md:flex md:flex-col md:gap-3">
              ...
              <p className="text-sm text-gray-500 ">
                Lorem Ipism color description is very good to have
              </p>
          ...
          <div className="w-full flex flex-row flex-wrap gap-2 xl:w-1/3">
            ...
            <div className="w-full bg-white flex gap-2 items-center px-2 py-4  xl:w-[48%]">
              ...
              <div className="">
                ...
                <p className="text-sm text-gray-500 xl:text-xs">Branches</p>
              </div>
            </div>
            <div className="w-full bg-white flex gap-2 items-center px-2 py-4  xl:w-[48%]">
            ...
            <div className="w-full bg-white flex gap-2 items-center px-2 py-4  xl:w-[48%]">
              ...
              <div className="">
                ...
                <p className="text-sm text-gray-500 xl:text-xs">Classes</p>
              </div>
            </div>
          </div>
        </div>
        <div className="w-full  h-[580px] bg-white overflow-y-scroll bigcalender">
          <h1 className="text-lg font-semibold md:text-xl p-4">
            Teacher&apos;s Schedule
          </h1>
          <BigCalender />
        </div>
      ...
      <div className="w-full xl:w-1/3">
        <div className="w-full h-fit bg-white rounded-md p-4">
          ...
          <div className="w-full flex flex-wrap gap-2">
            <Link
              href="/"
              className="w-fit px-3 py-2  rounded-md  text-sm text-gray-500 bg-roshanSkyLight"
            >
              Teacher&apos;s Students
            </Link>
            <Link
              href="/"
              className="w-fit px-3 py-2  rounded-md  text-sm text-gray-500 bg-roshanPurpleLight"
            >
              Teacher&apos;s Lessons
            </Link>
            <Link
              href="/"
              className="w-fit px-3 py-2  rounded-md  text-sm text-gray-500 bg-roshanYellowLight"
            >
              Teacher&apos;s Exams
            </Link>
            <Link
              href="/"
              className="w-fit px-3 py-2  rounded-md  text-sm text-gray-500 bg-pink-50"
            >
              Teacher&apos;s Classes
            </Link>
            <Link
